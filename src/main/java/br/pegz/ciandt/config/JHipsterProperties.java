...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "vacationplanner@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "vacationplanner API";

        private String description = "vacationplanner API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "vacationplanner";
