package br.pegz.ciandt.web.websocket;

import br.pegz.ciandt.security.SecurityUtils;
import br.pegz.ciandt.web.websocket.dto.ActivityDTO;
...
import static br.pegz.ciandt.config.WebsocketConfiguration.IP_ADDRESS;
